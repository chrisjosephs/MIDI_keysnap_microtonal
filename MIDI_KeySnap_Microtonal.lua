...
desc: MIDI Snap To Key Microtonal
desc: MIDI Snap To Key Microtonal [original by IXix - microtonal support added by crimzonclotta]
...
slider4:root_midi_note=60<0,127,1>Root MIDI Note (0-127)
slider5:/tuning/midi_keysnap_microtonal/scales:none:Scale File
slider6:1<0,1,1{Block,Remap}>Mode
slider7:1<0,1,1{Off,On}>On/Off
slider8:/tuning/midi_keysnap_microtonal/tunings:none:Tuning File
